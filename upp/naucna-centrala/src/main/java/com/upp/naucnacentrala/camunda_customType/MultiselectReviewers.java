...
public class MultiselectReviewers extends SimpleFormFieldType {

    public final static String TYPE_NAME = "multiselectR";

    protected Map<String, String> values;

    public MultiselectReviewers() {
        this.values = new HashMap<>();
    }

    public MultiselectReviewers(Map<String, String> values) {
        this.values = values;
    }
